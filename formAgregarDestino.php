...
?>
                ...
                <div class="form-group">
                    <div class="input-group mb-2">
                        ...
                        <input type="number" name="destPrecio" class="form-control" placeholder="Ingrese el precio" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group mb-2">
                        ...
                        <input type="number" name="destAsientos" class="form-control" placeholder="Ingrese cantidad de Asientos Totales" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group mb-2">
                        ...
                        <input type="number" name="destDisponibles" class="form-control" placeholder="Ingrese cantidad de Asientos Disponibles" required>
                    </div>
                </div>
